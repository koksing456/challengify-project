...
*/
-- DropForeignKey
ALTER TABLE "ChallengeHistory" DROP CONSTRAINT "ChallengeHistory_userId_fkey";

-- DropForeignKey
ALTER TABLE "FavoriteChallenge" DROP CONSTRAINT "FavoriteChallenge_userId_fkey";

-- DropForeignKey
ALTER TABLE "UserProgress" DROP CONSTRAINT "UserProgress_userId_fkey";

-- AlterTable
ALTER TABLE "ChallengeHistory" ALTER COLUMN "userId" SET DATA TYPE TEXT;

-- AlterTable
ALTER TABLE "FavoriteChallenge" ALTER COLUMN "userId" SET DATA TYPE TEXT;
