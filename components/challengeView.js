        ...
        <section class="py-12 bg-white sm:py-16 lg:py-20">
            <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="text-center">
                    <h2 class="text-3xl font-bold leading-tight text-gray-900 sm:text-4xl xl:text-5xl font-pj">Unleash Your Power!</h2>
                    <p class="mt-4 text-base leading-7 text-gray-600 sm:mt-8 font-pj">Dive into daily AI-crafted challenges and ignite your growth. Commit, conquer, and share your journey with Challengify!</p>
                    <p class="text-xl font-semibold text-red-600 bg-red-100 px-6 py-3 rounded-full inline-block shadow-md animate-pulse mt-5">
                ...
                <div class="grid grid-cols-1 mt-10 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-3 md:gap-0 xl:mt-24">
                    <div class="md:p-8 lg:p-14">
                        ...
                        <h3 class="mt-12 text-xl font-bold text-gray-900 font-pj">{challenges[0].title}</h3>
                        <p class="mt-5 text-base text-gray-600 font-pj">{challenges[0].description}</p>
                        <p class="mt-12 text-s text-gray-400 border">#{challenges[0].tag}</p>
                    </div>
                    ...
                    <div class="md:p-8 lg:p-14 md:border-l md:border-gray-200">
                        ...
                        <h3 class="mt-12 text-xl font-bold text-gray-900 font-pj">{challenges[1].title}</h3>
                        <p class="mt-5 text-base text-gray-600 font-pj">{challenges[1].description}</p>
                        <p class="mt-12 text-s text-gray-400 border">#{challenges[1].tag}</p>
                    ...
                    <div class="md:p-8 lg:p-14 md:border-l md:border-gray-200">
                        ...
                        <h3 class="mt-12 text-xl font-bold text-gray-900 font-pj">{challenges[2].title}</h3>
                        <p class="mt-5 text-base text-gray-600 font-pj">{challenges[2].description}</p>
                        <p class="mt-12 text-s text-gray-400 border">#{challenges[2].tag}</p>
                    ...
                    <div class="md:p-8 lg:p-14 md:border-t md:border-gray-200">
                        ...
                        <h3 class="mt-12 text-xl font-bold text-gray-900 font-pj">{challenges[3].title}</h3>
                        <p class="mt-5 text-base text-gray-600 font-pj">{challenges[3].description}</p>
                        <p class="mt-12 text-s text-gray-400 border">#{challenges[3].tag}</p>
                    </div>
                    ...
                    <div class="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
                        ...
                        <h3 class="mt-12 text-xl font-bold text-gray-900 font-pj">{challenges[4].title}</h3>
                        <p class="mt-5 text-base text-gray-600 font-pj">{challenges[4].description}</p>
                        <p class="mt-12 text-s text-gray-400 border">#{challenges[4].tag}</p>
                    </div>
                    ...
                    <div class="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
                        ...
                        <h3 class="mt-12 text-xl font-bold text-gray-900 font-pj">{challenges[5].title}</h3>
                        <p class="mt-5 text-base text-gray-600 font-pj">{challenges[5].description}</p>
                        <p class="mt-12 text-s text-gray-400 border">#{challenges[5].tag}</p>
                    </div>
                </div>
            </div>
        </section>
